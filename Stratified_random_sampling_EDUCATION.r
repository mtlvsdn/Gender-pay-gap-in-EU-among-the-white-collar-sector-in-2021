...
#URBAN POPULATION
urban <- data["Education"] #DATA URBAN
col_urban_west <- sample_west["Education"] #DATA WEST
col_urban_east <- sample_east["Education"] #DATA EAST
...
sample_west <- strata_west[-c(11,13,14,10,12,2,8,7,5,9), ] #WE CHOOSE A SAMPLE FOR WEST STRATA RANDOMLY
sample_east <- strata_east[-c(12,6,11,10,7,3,4,1), ] #WE CHOOSE A SAMPLE FOR EAST STRATA RANDOMLY
sample_west_urban <- sample_west["Education"]
sample_east_urban <- sample_east["Education"]
