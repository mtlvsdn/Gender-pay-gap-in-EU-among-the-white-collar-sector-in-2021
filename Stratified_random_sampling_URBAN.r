...
#URBAN POPULATION
urban <- data["Urban_population"] #DATA URBAN
col_urban_west <- sample_west["Urban_population"] #DATA WEST
col_urban_east <- sample_east["Urban_population"] #DATA EAST
...
sample_west <- strata_west[-c(6), ] #WE CHOOSE A SAMPLE FOR WEST STRATA RANDOMLY
sample_east <- strata_east[-c(5,7,9,10,12,13), ] #WE CHOOSE A SAMPLE FOR EAST STRATA RANDOMLY
sample_west_urban <- sample_west["Urban_population"]
sample_east_urban <- sample_east["Urban_population"]
...
hist(sample_west_urban, breaks = 13, main = "Distribution of Urbanization in Western EU in 2021", xlab = "Urbanization Rate", col = 'lightblue')
View(sample_west_urban)
# DISTRIBUTION OF SAMPLE EAST
View(sample_east_urban)
hist(sample_east_urban, breaks = 7, main = "Distribution of Urbanization in Eastern EU in 2021", xlab = "Urbanization Rate", col = 'orange')
...
plotCI(
  ...
  main = "Confidence Intervals for Urbanization in Western and Eastern EU in 2021"
)
...
plotCI(
  ...
  main = "Confidence Intervals for Urbanization in Western and Eastern EU in 2021",  # Main plot title
