...
#URBAN POPULATION
urban <- data["Arts"] #DATA URBAN
col_urban_west <- sample_west["Arts"] #DATA WEST
col_urban_east <- sample_east["Arts"] #DATA EAST
...
sample_west_urban <- sample_west["Arts"]
sample_east_urban <- sample_east["Arts"]
